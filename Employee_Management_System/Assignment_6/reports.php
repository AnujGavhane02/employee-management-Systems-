...
<div class="sidebar">
  <div class="p-3">
    ...
    <ul class="nav flex-column">
      <li class="nav-item">
        <a class="nav-link" href="index.php?tab=dashboard"><i class="fas fa-home"></i> Dashboard</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?tab=employees"><i class="fas fa-users"></i> Employees</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="index.php?tab=reports"><i class="fas fa-chart-bar"></i> Reports</a>
      </li>
      <li class="nav-item">
...
<div class="content">
  <div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <a href="index.php?tab=employees" class="btn btn-outline-primary"><i class="fas fa-arrow-left"></i> Back to Employees</a>
  </div>
