...
<div class="sidebar">
  <div class="p-3">
    ...
    <ul class="nav flex-column">
      <li class="nav-item">
        <a class="nav-link active" href="index.php?tab=dashboard"><i class="fas fa-home"></i> Overview</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?tab=employees"><i class="fas fa-users"></i> Employees</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?tab=reports"><i class="fas fa-chart-bar"></i> Reports</a>
      </li>
      <li class="nav-item">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <a href="index.php?tab=employees" class="btn btn-primary me-2"><i class="fas fa-plus"></i> Add Employee</a>
          <a href="index.php?tab=reports" class="btn btn-secondary"><i class="fas fa-chart-bar"></i> View Reports</a>
        </div>
      </div>
    </div>
  </div>
